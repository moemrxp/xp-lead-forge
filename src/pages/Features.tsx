  ...
  const featureSections = [
    {
      ...
      features: [
        ...
        "Click-to-call functionality that works on any device",
        "Automated response scheduling for off-hours",
        "Message templates for quick, consistent replies"
      ],
      imagePosition: "right"
    },
    {
    ...
    },
    {
      ...
      icon: Edit,
      features: [
        "Customizable quote templates with your branding",
        "Digital signature collection",
        "Automated follow-ups for pending quotes",
        "Conversion tracking from quote to job"
      ],
      imagePosition: "right"
    },
    {
      ...
      icon: Link,
      features: [
        "Mobile-optimized mini-website with your branding",
        ...
        <section className="py-20 bg-mrxp-primary">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Our platform is designed specifically for experienced professionals in home services 
              who want to grow their business with quality leads and modern tools.
            </p>
          </div>
        </section>
