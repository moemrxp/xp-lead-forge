...
const PricingTier = ({ 
  ...
  return (
    <div className={`bg-white rounded-xl shadow-md ${isPopular ? 'border-2 border-mrxp-primary' : 'border border-gray-200'} relative h-full`}>
      {isPopular && (
        ...
        <section className="py-20 bg-[#2563eb]">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto">
              Choose the plan that works best for your business. All plans include our core features with a 14-day free trial.
            </p>
          </div>
        </section>
